...
<div align="center">
  <figure style="display: inline-block; text-align: center; margin: 10px;">
    <img src="Img/bt_hist.png" alt="Distribution of the magnitude of the IMF" width="300">
  </figure>
  <figure style="display: inline-block; text-align: center; margin: 10px;">
    <img src="Img/density_hist.png" alt="Distribution of the proton density" width="300">
  </figure>
  <figure style="display: inline-block; text-align: center; margin: 10px;">
    <img src="Img/temperature_hist.png" alt="Distribution of the proton temperature" width="300">
  </figure>
</div>
...
<div align="center">
  <figure style="display: inline-block; text-align: center; margin: 10px;">
    <img src="Img/all_quantile.png" alt="QQ-plot performed on different sequences showing indications of heavy tails" width="300">
  </figure>
  <figure style="display: inline-block; text-align: center; margin: 10px;">
    <img src="Img/all_dist_funct.png" alt="Distribution function of the logistic model fitted to the data" width="300">
  </figure>
  <figure style="display: inline-block; text-align: center; margin: 10px;">
    <img src="Img/all_dens_funct.png" alt="Density function of the logistic model fitted to the data" width="300">
  </figure>
</div>
